...
def main():
    ...
    # Gradient coloring for markers with clearer order representation
    n_markers = len(cycle_df)
    colormap = cm.LinearColormap(colors=['lightblue', 'darkblue'], vmin=0, vmax=n_markers-1)
